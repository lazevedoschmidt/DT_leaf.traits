...
div.mine.rF # explains 11.45% of the data 
...
#Saving figures----
ggsave("figures/rf.varsuper.figV2.pdf", varsuper.fig, height = 18, width = 15, units = "in")
