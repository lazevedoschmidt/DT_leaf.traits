...
#load data
widedata <- read.csv("Cleaned_data/trait.wide.clean_data_V2.csv") #V2 because the other files have the incorrect tannin data
newtraitHF <- read.csv("Cleaned_data/HFtrait.clean_data_V2.csv")
newtraitMD <- read.csv("Cleaned_data/MDtrait.clean_data_V2.csv")
newtraitLS <- read.csv("Cleaned_data/LStrait.clean_data_V2.csv")
###############################################################################
...
#MD specific models----
#Interaction terms of CN * LMA were only included if they strengthened the models. Otherwise the terms were added (+) 
